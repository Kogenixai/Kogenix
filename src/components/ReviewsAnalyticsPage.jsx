    ...
    <section className="min-h-screen px-6 py-20 bg-background">
      <div className="max-w-5xl mx-auto space-y-14">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-black tracking-tight">FDP Session Analytics</h1>
          ...
          <PremiumCard title="Department Participants" badge="5 Departments" accentColor="#34d399">
            ...
            <ResponsiveContainer width="100%" height={140}>
              <BarChart data={departmentData} layout="vertical" barCategoryGap="22%">
                <defs>
                  {departmentData.map((d, i) => (
                    <linearGradient key={i} id={`dGrad${i}`} x1="0" y1="0" x2="1" y2="0">
